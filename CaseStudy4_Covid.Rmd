---
title: "Case study 4: Covid case study"
author: "Sara Taheri"
date: "`r Sys.Date()`"
...
# Create interventional data for Covid model
...
for (seed in startSeed:(startSeed+K-1)) {
  ...
  interventional_data <- data.frame("U1_SARS_Ang" = U1_SARS_Ang
                                    ,"U2_SARS_Ang" = U2_SARS_Ang
                                    ,"SARS_COV2" = SARS_COV2
                                    ,"ACE2" = ACE2
                                    ,"Ang" = Ang
                                    ...
                                    ,"IL6AMP" = IL6AMP
                                    ,"cytok" = cytok)
    intv_data_list[[data_count]] <- interventional_data
    data_count = data_count + 1
}
...
```{r}
#write.csv(intv_data_list[[1]], file = "data/Case4/obs_intv_data/intv_data1_Case4.csv")
```
...
for (num_data_points in ndp) {
  ...
  for (data_count in 1:K) {
    ...
    # }
    hmc_fit_list[[data_count]] <- rstan::sampling(mod, data=data_list, chains = 2, iter = 3000, warmup = 1500, seed = 1, control = list(max_treedepth = 15
                                                                                                                                        #, adapt_delta = 0.99
    )
    )
    samples_hmc <- rstan::extract(hmc_fit_list[[data_count]], parameters)
    
    estimated_y_hmc_list[[data_count]] <-  mutilated_model_sil6r(mu_U1_SARS_Ang = mean(samples_hmc$mu_U1_SARS_Ang),
    ...
    means_hmc <- c(means_hmc,abs(mean(estimated_y_hmc_list[[data_count]]) - mean(intv_data_list[[data_count]]$cytok)))
  }
...
end_time <- Sys.time()
end_time - start_time
#saveRDS(means_hmc_list,file = "data/Case4/output/means_hmc_list_Case4_sil6r.RData")
```
...
for (num_data_points in ndp) {
  ...
  for (data_count in 1:K) {
    ...
    estimated_y_hmc_list[[data_count]] <-  mutilated_model_egfr(mu_U1_SARS_Ang = mean(samples_hmc$mu_U1_SARS_Ang),
                                                           sigma_U1_SARS_Ang = mean(samples_hmc$sigma_U1_SARS_Ang),
                                                           mu_U2_SARS_Ang = mean(samples_hmc$mu_U2_SARS_Ang),
                                                           sigma_U2_SARS_Ang = mean(samples_hmc$sigma_U2_SARS_Ang),
                                                           beta0_U_SARS_AngToSARS_COV2 = mean(samples_hmc$beta0_U_SARS_AngToSARS_COV2),
...
end_time <- Sys.time()
end_time - start_time
#saveRDS(means_hmc_list,file = "data/Case4/output/means_hmc_list_Case4_egfr.RData")
```
...
estimated_y_hmc_list_misspecify_egfr <- list()
estimated_y_hmc_list_misspecify_sil6r <- list()
...
for (num_data_points in ndp) {
  ...
  for (data_count in 1:K) {
    ...
    hmc_fit_list_misspecify[[data_count]] <- rstan::sampling(mod_misspecify, data=data_list, chains = 2, iter = 3000, warmup = 1500, seed = 2, control = list(max_treedepth = 15)) #seed = 1
  }
}
...
for (num_data_points in ndp) {
  ...
  for (data_count in 1:K) {
    print("data_count is:")
    print(data_count)    
    samples_hmc_misspecify <- rstan::extract(hmc_fit_list_misspecify[[data_count]], parameters_misspecify)
    
    estimated_y_hmc_list_misspecify_egfr[[data_count]] <-  mutilated_model_misspecify_egfr(mu_U_SARS_Ang = mean(samples_hmc_misspecify$mu_U_SARS_Ang),
    ...
    estimated_y_hmc_list_misspecify_sil6r[[data_count]] <-  mutilated_model_misspecify_sil6r(mu_U_SARS_Ang = mean(samples_hmc_misspecify$mu_U_SARS_Ang),
                                                                                 sigma_U_SARS_Ang = mean(samples_hmc_misspecify$sigma_U_SARS_Ang),
                                                                                 beta0_U_SARS_AngToSARS_COV2 = mean(samples_hmc_misspecify$beta0_U_SARS_AngToSARS_COV2),
                                                                                 beta_U_SARS_AngToSARS_COV2 = mean(samples_hmc_misspecify$beta_U_SARS_AngToSARS_COV2),
                                                                                 beta0_SARS_COV2ToACE2 = mean(samples_hmc_misspecify$beta0_SARS_COV2ToACE2),
    ...
    means_hmc_misspecify_egfr <- c(means_hmc_misspecify_egfr,abs(mean(estimated_y_hmc_list_misspecify_egfr[[data_count]]) - mean(intv_data_list[[data_count]]$cytok)))
    means_hmc_misspecify_sil6r <- c(means_hmc_misspecify_sil6r,abs(mean(estimated_y_hmc_list_misspecify_sil6r[[data_count]]) - mean(intv_data_list[[data_count]]$cytok)))
...
end_time <- Sys.time()
end_time - start_time
#saveRDS(means_hmc_list_misspecify_sil6r, file = "data/Case4/output/means_hmc_list_misspecify_Case4_sil6r.RData")
```
...
for (num_data_points in ndp) {
  ...
  for (data_count in 1:K) {
    ...
    hmc_fit_list_plug_in[[data_count]] <- rstan::sampling(mod_plug_in_sil6r, data=data_list, chains = 2, iter = 3000, warmup = 1500, seed = 1, control = list(max_treedepth = 15))
    
    samples_hmc_plug_in <- rstan::extract(hmc_fit_list_plug_in[[data_count]], c("mu_AGTR1", "sigma_AGTR1",
                                                                                "beta0_ADAM17", "beta_AGTR1ToADAM17",
                                                                                "beta0_cytok", "beta_Sil6rTocytok", "beta_ADAM17Tocytok", "beta_AGTR1Tocytok"))
    
    estimated_y_hmc_list_plug_in[[data_count]] <-  mutilated_model_plug_in_sil6r(mu_AGTR1 = mean(samples_hmc_plug_in$mu_AGTR1),
    ...
    means_hmc_plug_in <- c(means_hmc_plug_in,abs(mean(estimated_y_hmc_list_plug_in[[data_count]]) - mean(intv_data_list[[data_count]]$cytok)))
    
  }
  means_hmc_list_plug_in[[paste0("num_data_points_",num_data_points)]] <- means_hmc_plug_in
  means_hmc_plug_in <- c()
}
#saveRDS(means_hmc_list_plug_in, file = "data/Case4/output/means_hmc_list_plug_in_Case4_sil6r.RData")
```
...
for (num_data_points in ndp) {
  ...
  for (data_count in 1:K) {
    ...
    hmc_fit_list_plug_in[[data_count]] <- rstan::sampling(mod_plug_in_egfr, data=data_list, chains = 2, iter = 3000, warmup = 1500, seed = 1, control = list(max_treedepth = 15))
    ...
    estimated_y_hmc_list_plug_in[[data_count]] <-  mutilated_model_plug_in_egfr(mu_AGTR1 = mean(samples_hmc_plug_in$mu_AGTR1),
                                                                           sigma_AGTR1 = mean(samples_hmc_plug_in$sigma_AGTR1),
...
#saveRDS(means_hmc_list_plug_in, file = "data/Case4/output/means_hmc_list_plug_in_Case4_egfr.RData")
```
