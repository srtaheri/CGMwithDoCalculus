...
gg1
ggsave("MulticauseAE.pdf", plot = gg1, width = 7, height = 7, dpi = 300, units = "in")
#True LVM :orange,
...
```{r}
#Case study 3 (igf)
means_hmc_list <- readRDS(file = "data/Case3_Signaling/output/means_hmc_list_Case3.RData")
means_hmc_list_misspecify <- readRDS(file = "data/Case3_Signaling/output/means_hmc_list_misspecify_Case3.RData")
means_hmc_list_plug_in <- readRDS(file = "data/Case3_Signaling/output/means_hmc_list_plug_in_Case3.RData")
...
scale_fill_manual(breaks = c("True LVM", "Misspecified LVM", "Dual IPW", "Primal IPW"),
                    values = c("#E69F00",     "#56B4E9",          "#0072B2", "#D55E00"    ))
gg3
#ggsave("SignalingAE.pdf", plot = gg3, width = 7, height = 7, dpi = 300, units = "in")
#True LVM :orange,
#Misspecified LVM : blue,
#Plug-in :green,
#Dual IPW: blue,
...
```{r}
#Case study 4 (covid)
means_hmc_list_sil6r <- readRDS(file = "data/Case4_Covid/output/means_hmc_list_Case4_sil6r.RData")
means_hmc_list_misspecify_sil6r <- readRDS(file = "data/Case4_Covid/output/means_hmc_list_misspecify_Case4_sil6r.RData")
means_hmc_list_plug_in_sil6r <- readRDS(file = "data/Case4_Covid/output/means_hmc_list_plug_in_Case4_sil6r.RData")
df_aipw_case4_sil6r <- read.csv(file="data/Case4_Covid/output/df_aipw_case4_sil6r.csv")
df_gformula_case4_sil6r <- read.csv(file="data/Case4_Covid/output/df_gformula_case4_sil6r.csv")
...
"model" = c(rep("True LVM",3*K), rep("Misspecified LVM", 3*K), rep("Plug-in", 3*K), rep("g-formula", 3*K), rep("Augmented IPW", 3*K))
)
...
# guides(fill=guide_legend(title="", nrow=3)) +
scale_fill_manual(breaks = c("True LVM", "Misspecified LVM", "Plug-in", "Augmented IPW", "g-formula"),
...
```{r}
#Case study 4 (covid)
means_hmc_list_egfr <- readRDS(file = "data/Case4_Covid/output/means_hmc_list_Case4_egfr.RData")
means_hmc_list_misspecify_egfr <- readRDS(file = "data/Case4_Covid/output/means_hmc_list_misspecify_Case4_egfr.RData")
means_hmc_list_plug_in_egfr <- readRDS(file = "data/Case4_Covid/output/means_hmc_list_plug_in_Case4_egfr.RData")
df_aipw_case4_egfr <- read.csv(file="data/Case4_Covid/output/df_aipw_case4_egfr.csv")
df_gformula_case4_egfr <- read.csv(file="data/Case4_Covid/output/df_gformula_case4_egfr.csv")
...
df_bp_AE <- dplyr::bind_rows(df_bp_AE1, df_bp_AE2, df_bp_AE3, df_bp_AE4_sil6r, df_bp_AE4_egfr)
...
gg <- df_bp_AE %>% ggplot(aes(x = as.factor(N), y = AE, fill=model)) +
  ...
  xlab("number of data points")  +
   guides(fill=guide_legend(title="", nrow=7)) +
   facet_wrap( ~ case, ncol=5, scales = "free") +
scale_fill_manual(breaks = c("True LVM", "Misspecified LVM", "Plug-in", "Augmented IPW", "g-formula", "Dual IPW", "Primal IPW"),
